...
AMATU_EFF_Fig= ggplot(AMATU_EFF_cld, aes(x= Herb, y= response*100, color= Herb))+
  geom_point(size= 4) +
  geom_text(aes(label= .group), nudge_y = c(5,5,7,8,10,10,10,10,12,20,17), size =7) +
  geom_errorbar(aes(ymin= lower.CL*100, ymax= upper.CL*100, width= 0.4))+
  geom_jitter(data= data2, mapping= aes(y=AMATU_EFF*100), alpha=0.2) +
...
CHEAL_EFF_Fig= ggplot(CHEAL_EFF_cld, aes(x= Herb, y= response*100, color= Herb))+
  geom_point(size= 4) +
  geom_text(aes(label= .group), nudge_y = c(5,5,5,5,5,5,5,13,35,31,20), size =7) +
  geom_errorbar(aes(ymin= lower.CL*100, ymax= upper.CL*100, width= 0.4))+
  geom_jitter(data= data2, mapping= aes(y=CHEAL_EFF*100), alpha=0.2) +
  theme(legend.position = "none",
        plot.title = element_text(size= 25),
        axis.text.x = element_text(size = 20),
        axis.text.y = element_text(size = 20),
...
AMATU_Count_Fig= ggplot(AMATU_Count_cld, aes(x= Herb, y= rate, color= Herb))+
  geom_point(size= 4) +
  geom_text(aes(label= .group), nudge_y = c(10,10,10,10,10,10,10,10,10,10,17,17), size = 7) +
  geom_errorbar(aes(ymin= lower.CL, ymax= upper.CL, width= 0.4))+
  geom_jitter(data= data1, mapping= aes(y=AMATU_Count), alpha=0.2) +
  theme(legend.position = "none",
        plot.title = element_text(size= 25),
        axis.text.x = element_text(size = 20),
        axis.text.y = element_text(size = 20),
        ...
        axis.title.y = element_text(size = 25)) +
  coord_flip() +
  scale_y_continuous(label.text, breaks= c(0,20,40,60,80,100), limits= c(-1,120)) + 
